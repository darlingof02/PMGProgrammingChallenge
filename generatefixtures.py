...
FILES = {
    'clothing_small.csv': ('Blouses', 'Shirts', 'Tanks', 'Cardigans', 'Pants', 'Capris', '"Gingham" Shorts',),
    'accessories_small.csv': ('Watches', 'Wallets', 'Purses', 'Satchels',),
    'household_cleaners_small.csv': ('Kitchen Cleaner', 'Bathroom Cleaner',),
}
